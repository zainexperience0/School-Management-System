...
export const StudentBox = ({ modelSlug, classId }: any) => {
  const [searchQuery, setSearchQuery] = useState(`&eq=true&fields=classId&classId=${classId}`);
  ...
  return (
    <div className="mt-10 max-w-5xl mx-auto px-2 space-y-10 pb-20">
      ...
      {/* <CreateField
        modelSlug={"student"}
        relation={{ student: { connect: { id: classId } } }}
        callbackFn={() => {
          reload();
        }}
        page={false}
