...
export const ViewTask = ({ modelSlug, id }: any) => {
  useAdminCheck();
  ...
  return (
    <div className="max-w-5xl mx-auto my-10 px-4">
      ...
      <div className="border p-2">
        <h1 className="border-b">Content</h1>
        <MarkdownViewer content={data.content} />
      </div>
      <div className="border p-2">
        <h1 className="border-b">Acceptance Criteria</h1>
        <MarkdownViewer content={data.delieveryCreteria} />
      </div>
    </div>
  );
};
